...
module.exports = class extends Generator {
  ...
  prompting() {
    ...
    return this.prompt([
      ...
      //   indexApi: answers.indexApi ? API_BATH + answers.indexApi : null,
      //   createApi: answers.createApi ? API_BATH + answers.createApi : null,
      //   updateApi: answers.updateApi ? API_BATH + answers.updateApi : null,
      //   deleteApi: answers.deleteApi ? API_BATH + answers.deleteApi : null,
      // });
    });
  }
